...
The unit suite covers stack mutations, deterministic output routing, two-context desktop and output transfer commits and rollback, floating placement anchors and transactional ownership, active-column reorder, width constraints and rollback, the two-sample topology barrier, output and dock invalidations, waiting-only and hidden contexts, deterministic structural merges, sticky restore invalidation, capacity eviction and retry, and stale callback cancellation.
