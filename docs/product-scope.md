...
- Native maximize-to-edges control through KWin with retained layout participation.
...
- Toggling native maximize calls KWin's maximize mechanism and retains the prior layout slot for restoration.
