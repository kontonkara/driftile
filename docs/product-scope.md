...
- Stacked native-state extraction may pass settled minimized peers, retaining their exact slots without frame writes. Whole-column transfers remain unavailable when a participating member is minimized; other hidden-member edit semantics remain MVP work.
