...
Download `driftile-overview-1.65.0.kwineffect` and `SHA256SUMS` from the stable
[1.65.0 release](https://github.com/kontonkara/driftile/releases/tag/v1.65.0),
...
kpackagetool6 --type=KWin/Effect \
  --install ./driftile-overview-1.65.0.kwineffect
```
...
The 1.65.0 flake exposes the effect separately as
