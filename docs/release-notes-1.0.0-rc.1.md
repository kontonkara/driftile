...
Driftile 1.0.0-rc.1 is a prerelease candidate for testing the 1.0 release. It
is not a stable release; 0.1.0 remains the latest stable version.
...
- `driftile-1.0.0-rc.1.kwinscript`
- `driftile-shortcuts-1.0.0-rc.1.mjs`, if using the portable helper
- `SHA256SUMS`
- `LICENSE`
