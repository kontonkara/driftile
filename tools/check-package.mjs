...
const expectedRuntimeEntries = [
  ...
  "ui/OverviewWorkspaceCommandReceiver.qml",
...
const expectedOverviewRuntimeEntries = [
  ...
  "ui/OverviewTouchpadZoomGesture.qml",
  "ui/OverviewTouchscreenZoomGesture.qml",
  "ui/OverviewWorkspaceCommandWriter.qml",
  "ui/OverviewZoomHud.qml",
