...
- Finish-only pointer reinsertion within one visible layout and adoption into
  an exact visible tiled target after a KWin-owned output or desktop move.
...
The latest stable release is [1.5.0](docs/release-notes-1.5.0.md).

The `main` branch tracks `1.6.0-dev.0` and is not a stable release.
...
The 1.5.0 release also provides the separate overview effect. It is disabled
